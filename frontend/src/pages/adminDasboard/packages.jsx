        ...
        <body class="bg-gray-100">
            <div class="flex h-screen">
                ...
                <aside class="w-64 bg-gray-900 text-white">
                    ...
                    <nav class="mt-5 px-2">
                        ...
                        <div class="space-y-4">
                            ...
                            {/* <!-- Projects --> */}
                            <Link to="./" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white group transition-all duration-200">
                                <svg class="h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            {/* <!-- Calendar --> */}
                            <Link to="./alerts" class="flex items-center px-4 py-2.5 mb-4 text-sm font-medium rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white group transition-all duration-200">
                                <svg class="h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                Alerts
                ...
                <main class="flex-1 p-6 bg-gray-100">
                    <h1 class="text-2xl font-semibold text-gray-900">Dashboard Packages</h1>
