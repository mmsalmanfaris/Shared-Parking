        ...
        <>
            ...
            <div class="bg-white dark:bg-gray-800 flex relative z-20 items-center overflow-hidden">
                <div class="container mx-auto px-6 flex relative py-16">
                    <div class="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20">
                        ...
                        <div class="flex mt-8">
                            <a href="#" class="uppercase py-2 px-4 rounded-lg bg-blue-700 border-2 border-transparent text-white text-md mr-4 hover:bg-pink-400">
                                Contact Us
                            </a>
                            <a href="#" class="uppercase py-2 px-4 rounded-lg bg-transparent border-2 border-blue-700 text-blue-700 dark:text-white hover:bg-pink-500 hover:text-white text-md">
                                Packages
                            </a>
                        </div>
                    </div>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Seamless Parking, <br /> Smarter Experience.</h2>
                        <p className="mb-4">We are strategists, designers and developers. Innovators and problem solvers. Small enough to be simple and quick, but big enough to deliver the scope you want at the pace you need. Small enough to be simple and quick, but big enough to deliver the scope you want at the pace you need.</p>
                        <p>We are strategists, designers and developers. Innovators and problem solvers. Small enough to be simple and quick.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mt-8">
                        <img className="w-full rounded-lg" src="https://images.unsplash.com/photo-1543465077-db45d34b88a5?q=80&w=1965&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="office content 1" />
                        <img className="mt-4 w-full lg:mt-10 rounded-lg" src="https://plus.unsplash.com/premium_photo-1661502715768-a25053963716?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="office content 2" />
            ...
            <section>
                <div class="sm:flex sm:flex-col sm:align-center p-10">
                    <div class="relative self-center bg-slate-200 rounded-lg p-3 flex">
                        <p>Users can choose the packages absed on their needs and wants.</p>
                    </div>
                    <div
                        ...
                        <div class="border border-slate-200 rounded-lg shadow-sm divide-y divide-slate-200">
                            <div class="p-6">
                                <h2 class="text-xl leading-6 font-bold text-slate-900">Day Parking</h2>
                                <p class="mt-2 text-base text-slate-700 leading-tight">For those needing to park from morning to evening.</p>
                                <p class="mt-8">
                                    <span class="text-4xl font-bold text-slate-900 tracking-tighter">Rs. 10000</span>

                                    <span class="text-base font-medium text-slate-500">/mo</span>
                                </p><a href="/sign-up"
                                    class="mt-8 block w-full bg-blue-700 rounded-md py-2 text-sm font-semibold text-white text-center">Rent a Parking</a>
                            </div>
                        ...
                        <div class="border border-slate-200 rounded-lg shadow-sm divide-y divide-slate-200">
                            <div class="p-6">
                                <h2 class="text-xl leading-6 font-bold text-slate-900">Night parking</h2>
                                <p class="mt-2 text-base text-slate-700 leading-tight">For parking during night-time hours.</p>
                                <p class="mt-8">
                                    <span class="text-4xl font-bold text-slate-900 tracking-tighter">Rs. 15000</span>
                        ...
                        <div class="border border-slate-200 rounded-lg shadow-sm divide-y divide-slate-200">
                            <div class="p-6">
                                <h2 class="text-xl leading-6 font-bold text-slate-900">Full day parking</h2>
                                <p class="mt-2 text-base text-slate-700 leading-tight">No time restriction. Can use the slot for a month.</p>
                                <p class="mt-8">
                                    <span class="text-4xl font-bold text-slate-900 tracking-tighter">Rs. 20000</span>
            ...
            <section>
                <div class="max-w-6xl mt-12 mx-auto rounded-3xl bg-gray-100 px-6 py-16 text-center mb-30">
                    <div class="relative m-auto max-w-xl">
                        ...
                        <svg class="absolute top-24 -right-10 hidden h-36 fill-current text-slate-body sm:block md:-right-14 md:h-44"
