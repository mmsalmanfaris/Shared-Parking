...
const Contact = () => {
    return (
        <>
            ...
            <div class="my-20">
                <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-7xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                    <div>
                            ...
                            <ul class="mt-3">
                                <li class="flex items-center">
                                    ...
                                    <a target="blank" href="https://veilmail.io/e/FkKh7o" class="text-[#007bff] text-sm ml-3">
                                        ...
                                        <strong>inf0@sharedparking.lk</strong>
                                    </a>
                                </li>
                            </ul>
                        </div>
